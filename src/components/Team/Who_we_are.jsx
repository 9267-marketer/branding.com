          ...
          <div className="col-lg-5 valign">
            <div className="content wow fadeInUp md-mb30" data-wow-delay=".5s">
              ...
              <h3 className="co-tit mb-15">
                Revive and Rejuvenate Brands.
              </h3>
              <p>
                We are <br/>Brandaissance<br/>. We revive, transform, and inspire brands so they can create lasting impact and achieve market success.
              </p>
